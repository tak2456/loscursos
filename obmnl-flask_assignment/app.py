...
def search_transaction():
    if request.method == 'POST':
        ...
        # Render the search results template and pass the filtered transactions
        return render_template("transactions.html", transactions=filtered_transactions)

    # Render the search form template if the request method is GET
...
def total_balance():
    ...
    # Render the total balance template and pass the total balance value
    return render_template("transactions.html", total=total, transactions=transactions)
